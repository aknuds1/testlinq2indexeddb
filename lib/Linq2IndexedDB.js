    ...
    var utilities = {
        ...
        linq2indexedDBWorker: function (data, filters, sortClauses) {
            return utilities.promiseWrapper(function (pw) {
                if (!!window.Worker) {
                    linq2indexedDB.prototype.utilities.log(linq2indexedDB.prototype.utilities.severity.information, "Starting web worker",
                        utilities.linq2indexedDBWorkerFileLocation);
